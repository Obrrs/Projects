...
function displayVerticalList(escolas, containerId) {
   ...
   if (!escolas || escolas.length === 0) {
       container.innerHTML = '<p class="text-center text-muted">Nenhum TeSP encontrado.</p>';
       return;
   }
...
document.addEventListener('DOMContentLoaded', () => {
   console.log("INFO: DOM cursosSuperiores.html carregado.");
   // ...chama a função para carregar as escolas no div correto.
   loadEscolasPorTipo('Curso Superior', 'cursos-superiores-list');
